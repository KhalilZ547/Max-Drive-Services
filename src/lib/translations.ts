...
export const translations = {
  en: {
    ...
    contact_form_message_placeholder: "I have a question about the brake repair service for my Audi A3...",
    ...
    vehicle_label: "Vehicle Details",
    date_label: "Preferred Date",
    notes_label: "Additional Notes",
    book_now_button: "Book Now",
    vehicle_input_description: "This vehicle will be added to your profile.",
  ...
  fr: {
    ...
    contact_form_email: "Email",
    contact_form_message: "Message",
    contact_form_message_placeholder: "J'ai une question concernant le service de réparation des freins pour mon Audi A3...",
    ...
    service_label: "Service",
    vehicle_label: "Détails du véhicule",
    date_label: "Date Préférée",
    notes_label: "Notes Supplémentaires",
    book_now_button: "Réserver maintenant",
    vehicle_input_description: "Ce véhicule sera ajouté à votre profil.",
    ...
    change_photo_button: "Changer de photo",
  ...
  ar: {
    ...
    contact_form_message_placeholder: "لدي سؤال بخصوص خدمة إصلاح الفرامل لسيارتي أودي A3...",
    ...
    vehicle_label: "تفاصيل المركبة",
    date_label: "التاريخ المفضل",
    notes_label: "ملاحظات إضافية",
    book_now_button: "احجز الآن",
    vehicle_input_description: "سيتم إضافة هذه المركبة إلى ملفك الشخصي.",
    ...
    change_photo_button: "تغيير الصورة",
    delete_photo_button: "حذف الصورة",
